    ...
    <!-- /.content-header -->
        ...
        <div class="content">
            <div class="container-fluid">
                <div class="row">
                <form action="{{ url('/admin/roles/store') }}" method="POST" style="width:100%" enctype="multipart/form-data">
                    ...
                    <div class="col-md-12">
                        <form action="{{ url('/admin/roles/store') }}" method="POST" enctype="multipart/form-data">
                            ...
                            <div  class="form-group">
                                <label >Mô tả</label>
                                <textarea  type="text" rows="4" name="display_name" class="form-control " >  {{old('display_name')}}</textarea>
                            </div>
                                            ...
                                            <div class="row">
                                                @foreach ( $permissionsParentItem->permissionsChildrent as $permissionsParentItemChildrent )
                                                    ...
                                                    <div class="card-body col-md-3">
                                                        <h5 class="card-title">
                                                            <label >
                                                                <input type="checkbox" class="checkbox_childrent" name="permission_id[]" value="{{ $permissionsParentItemChildrent ->id }}">
                                                            </label>
